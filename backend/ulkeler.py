...
dataframe = openpyxl.load_workbook(r'C:\Users\habip\Documents\GitHub\ware_finans\backend\ulkeler.xlsx')
# read by default 1st sheet of an excel file
def veri_al(id,kod,icerik):

    cursor.execute("insert into bilgideposu_ulke_ulke_kodlari Values(?,?,?)",(id,kod,icerik))
    baglanti.commit()
