...
class tam_istisnaa_durumu(models.Model):
    bagli_oldugu_firma = models.ForeignKey(firma,blank=True,null=True,on_delete=models.SET_NULL)
    bagli_oldugu_beyanname = models.ForeignKey(kdv1_beyannamesi_bilgileri,blank=True,null=True,on_delete=models.SET_NULL)
    istisnaa1 = models.ForeignKey(kdv_istisna_kodu,on_delete=models.SET_NULL,blank = True,null = True,verbose_name =  "İstisna 1",related_name = "istisnaa_1")
    tamistisnamalhizmeti1 = models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnamalbedeli1= models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnayuklenilenkdv1= models.FloatField(verbose_name = "tutar",default = 0)
    istisnaa2 = models.ForeignKey(kdv_istisna_kodu,on_delete=models.SET_NULL,blank = True,null = True,verbose_name =  "İstisna 2",related_name = "istisnaa_2")
    tamistisnamalhizmeti2 = models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnamalbedeli2= models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnayuklenilenkdv2= models.FloatField(verbose_name = "tutar",default = 0)
    istisnaa3 = models.ForeignKey(kdv_istisna_kodu,on_delete=models.SET_NULL,blank = True,null = True,verbose_name =  "İstisna 3 ",related_name = "istisnaa_3")
    tamistisnamalhizmeti3 = models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnamalbedeli3 = models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnayuklenilenkdv3= models.FloatField(verbose_name = "tutar",default = 0)
    istisnaa4 = models.ForeignKey(kdv_istisna_kodu,on_delete=models.SET_NULL,blank = True,null = True,verbose_name =  "İstisna 4",related_name = "istisnaa_4")
    tamistisnamalhizmeti4 = models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnamalbedeli4= models.FloatField(verbose_name = "tutar",default = 0)
    tamistisnayuklenilenkdv4= models.FloatField(verbose_name = "tutar",default = 0)
    istisnaa5 = models.ForeignKey(kdv_istisna_kodu,on_delete=models.SET_NULL,blank = True,null = True,verbose_name =  "İstisna 5",related_name = "istisnaa_5")
