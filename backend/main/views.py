...
def yeni_kasa_karti_sayfasi(request,slug):
    ...
    hesaplar.ordered(HesapPlanlari.objects.filter(silinme_bilgisi = False,bagli_oldugu_firma =get_object_or_404(firma,silinme_bilgisi = False,firma_muhasabecisi = None )))
