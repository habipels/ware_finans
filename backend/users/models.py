...
class sube(models.Model):
    ...
    gecici_vergi_orani = models.FloatField(blank=True, null=True,verbose_name="Geçici Vergi Oranı %")
    silinme_bilgisi = models.BooleanField(default=False)
...
class sube_faliyet_bilgileri(models.Model):
    ...
    kurulus_tarihi = models.DateField(verbose_name="Kuruluş Tarihi",blank=True,null=True)
    terk_tarihi = models.DateField(verbose_name="Terk Tarihi",blank=True,null=True)
    ...
    ticaret_sicil_gazete = models.DateField(verbose_name="Ticaret Sicil Gazetesi Tarihi",blank=True,null=True)
...
class sgk_kanunlari(models.Model):
    isim = models.CharField(max_length=200,verbose_name="KAnun ADı Ve Numarası",null=True,blank=True)
class sgk_bilgileri(models.Model):
    sube_bilgisi = models.ForeignKey(sube,blank=True, null=True,on_delete=models.CASCADE)
    sgkdosyaacilistarihi = models.DateField(verbose_name="SGK DOSYA Açılış Tarihi",blank=True,null=True)
    sgkdosyakapanistarihi = models.DateField(verbose_name="SGK DOSYA Kapanış Tarihi",blank=True,null=True)
    sgkdosyam = models.CharField(max_length=100,verbose_name="SGK Dosya M",null=True,blank=True)
    sgkdosyaiskolukod = models.CharField(max_length=100,verbose_name="SGK İŞ KOLU KOD",blank=True,null=True)
    sgkdosyayeni = models.CharField(max_length=100,verbose_name="SGK Dosya Yeni",blank=True,null=True)
    sgkdosyaeski = models.CharField(max_length=100,verbose_name="SGK Dosya Eski",blank=True,null=True)
    sgkdosyaisyerisirano = models.CharField(max_length=100,verbose_name="SGK Dosya İŞ Yeri Sıra No",blank=True,null=True)
    sgkdosyailkodu = models.CharField(max_length=100,verbose_name="SGK Dosya İl kodu",blank=True,null=True)
    sgkdosyailcekodu = models.CharField(max_length=100,verbose_name="SGK Dosya İl kodu",blank=True,null=True)
    sgkdosyakontrolno =  models.CharField(max_length=100,verbose_name="SGK Dosya Kontrol No",blank=True,null=True)
    sgkdosyaarackodu = models.CharField(max_length=100,verbose_name="SGK Dosya Araç Kodu",blank=True,null=True)
    sgkdosyaiskodu = models.CharField(max_length=100,verbose_name="SGK Dosya İş Kodu",blank=True,null=True)
    sgkdosyasfkbolgemud = models.CharField(max_length=100,verbose_name="SGK Dosya Bölge Müd.",blank=True,null=True)
    sgkdosyail =  models.CharField(max_length=100,verbose_name="SGK Dosya İL ",blank=True,null=True)
    sgkdosyailce = models.CharField(max_length=100,verbose_name="SGK Dosya İlçe ",blank=True,null=True)
    sgkdosyatehlikederecesi =  models.CharField(max_length=100,verbose_name="SGK Dosya Tehlike Derecesi ",blank=True,null=True)
    sgkdosyatehlikesinifi = models.CharField(max_length=100,verbose_name="SGK Dosya Tehlike Sınıfı ",blank=True,null=True)
    sgkdosyaprimorani = models.CharField(max_length=100,verbose_name="SGK Dosya Prim Oranı ",blank=True,null=True)
    sgkfazlamesaiyuzdesialt = models.CharField(max_length=100,verbose_name="SGK Dosya Alt Yüzdesi ",blank=True,null=True)
    sgkfazlamesaiyuzdesiust = models.CharField(max_length=100,verbose_name="SGK Dosya Üst Yüzdesi",blank=True,null=True)
    sgkdosyalaribesuygulamasi = models.CharField(max_length=100,verbose_name="SGK Dosya Bes Uygulamaları",blank=True,null=True)
    sgkdosyatesfik6111kanun = models.CharField(max_length=100,verbose_name="SGK Dosya 6111 Sayılı Kanun Teşfiği",blank=True,null=True)
    sgkdosyatesfik6111faydalanmaayi = models.CharField(max_length=100,verbose_name="SGK Dosya 6111 Sayılı Kanun Faydalanma Süresi",blank=True,null=True)
    personel_girisinde_otomatik_kanun = models.ForeignKey(sgk_kanunlari,on_delete=models.SET_NULL,blank=True,null=True)
    personel_6116645yararlanmiyorsayenikanun = models.CharField(max_length=100,verbose_name="SGK Dosya 6111 Sayılı Kanun Faydalanma Süresi",blank=True,null=True)


class sgk_bolgecalisma_mudurlukleri(models.Model):
    sube_bilgisi = models.ForeignKey(sube,blank=True, null=True,on_delete=models.CASCADE)
    sgkbolges = models.CharField(max_length=100,verbose_name="SGK Bölge S",blank=True,null=True)
    sgkbolgemeslek = models.CharField(max_length=200,verbose_name="SGK Bölge Meslek",blank=True,null=True)
    sgkbolgedosyano = models.CharField(max_length=200,verbose_name="SGK Bölge Dosya No",blank=True,null=True)
    sgkbolgeilkodu = models.CharField(max_length=200,verbose_name="SGK Bölge İl Kodu",blank=True,null=True)
    sgkbolgeyazismaadresi = models.CharField(max_length=200,verbose_name="SGK Bölge Adresi",blank=True,null=True)
    sgkbolgetaseronadisoyadi= models.CharField(max_length=200,verbose_name="SGK Bölge Taşeron Adı Soyadı",blank=True,null=True)


class iskurbilgileri(models.Model):
    sube_bilgisi = models.ForeignKey(sube,blank=True, null=True,on_delete=models.CASCADE)
    iskurisyerinumarasi = models.CharField(max_length=200,verbose_name="İŞKUR İş Yeri Numarası",blank=True,null=True)
