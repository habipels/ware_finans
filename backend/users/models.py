...
class sgk_bilgileri(models.Model):
    ...
    sgkdosyaprimorani = models.FloatField(verbose_name="SGK Dosya Prim Oranı ",blank=True,null=True)
    sgkfazlamesaiyuzdesialt = models.FloatField(verbose_name="SGK Dosya Alt Yüzdesi ",blank=True,null=True)
    sgkfazlamesaiyuzdesiust = models.FloatField(verbose_name="SGK Dosya Üst Yüzdesi",blank=True,null=True)
